...
import com.appbytes.beautywallpaper.ui.main.collections.state.COLLECTIONS_DETAILS_VIEW_STATE_BUNDLE_KEY
import com.appbytes.beautywallpaper.ui.main.collections.state.CollectionsViewState
import com.appbytes.beautywallpaper.ui.main.collections.viewmodel.collectionsDetailsNextPage
import com.appbytes.beautywallpaper.ui.main.collections.viewmodel.refreshFromCacheCollectionsDetails
...
class CollectionsDetailsFragment : BaseCollectionsFragment(R.layout.fragment_collections_details), CollectionsDetailsAdapter.Interaction {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        savedInstanceState?.let { inState ->
            ...
            (inState[COLLECTIONS_DETAILS_VIEW_STATE_BUNDLE_KEY] as CollectionsViewState?)?.let { viewState ->
...
//        viewState?.imageFields?.images = ArrayList()
        outState.putParcelable(
                COLLECTIONS_DETAILS_VIEW_STATE_BUNDLE_KEY,
                viewState
        )
