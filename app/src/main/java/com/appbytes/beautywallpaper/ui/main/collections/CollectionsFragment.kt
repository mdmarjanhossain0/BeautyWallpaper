package com.appbytes.beautywallpaper.ui.main.collections
...
import com.appbytes.beautywallpaper.ui.main.collections.state.COLLECTIONS_VIEW_STATE_BUNDLE_KEY
import com.appbytes.beautywallpaper.ui.main.collections.state.CollectionsViewState
import com.appbytes.beautywallpaper.ui.main.collections.viewmodel.collectionsNextPage
import com.appbytes.beautywallpaper.ui.main.collections.viewmodel.refreshFromCacheCollections
import com.appbytes.beautywallpaper.ui.main.collections.viewmodel.setLayoutManagerState
...
class CollectionsFragment : BaseCollectionsFragment(R.layout.fragment_collections), CollectionsAdapter.Interaction {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        savedInstanceState?.let { inState ->
            ...
            (inState[COLLECTIONS_VIEW_STATE_BUNDLE_KEY] as CollectionsViewState?)?.let { viewState ->
...
//        viewState?.collectionsFields?.collections = ArrayList()
        outState.putParcelable(
                COLLECTIONS_VIEW_STATE_BUNDLE_KEY,
                viewState
        )
