...
const val BOTTOM_NAV_BACKSTACK_KEY = "com.appbytes.beautywallpaper.util.BottomNavController.bottom_nav_backstack"
    ...
    private fun createNavHost(menuItemId: Int): Fragment{
        return when(menuItemId){
            ...
            R.id.menu_nav_collections -> {
                CollectionsNavHostFragment.create(R.navigation.nav_collections)
            }
...
fun BottomNavigationView.setUpNavigation(
    ...
    bottomNavController.setOnItemNavigationChanged { itemId ->
        ...
        catch (expction : Exception) {
            expction.printStackTrace()
        }
    }
}
